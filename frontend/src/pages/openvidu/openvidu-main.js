...
const App = () => {
    ...
    const createSession = async (sessionId) => {
        const response = await axios.post('https://tel2.c4ei.net' + '/api/sessions', { customSessionId: sessionId }, {
    ...
    const createToken = async (sessionId) => {
        const response = await axios.post('https://tel2.c4ei.net' + '/api/sessions/' + sessionId + '/connections', {}, {
            headers: { 'Content-Type': 'application/json', },
        });
